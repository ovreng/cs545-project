...
Usage:
  ...
  python -m member_b2.run_experiments --total-timesteps 2000000

  # Quick sanity check
  python -m member_b2.run_experiments --total-timesteps 50000 --configs 2

  # Single config + seed
  python -m member_b2.run_experiments --total-timesteps 2000000 --configs 2 --seeds 42
"""
